<div class="space-y-4">
    ...
    <a href="<?php echo e(route('invoices.show', $invoice)); ?>" wire:navigate>
...
<?php $component->withName('ri-bill-line'); ?>
...
<?php endif; ?>
                    ...
                    <span class="font-medium">Invoice #<?php echo e($invoice->number); ?></span>
                    <span class="text-base/50 font-semibold">
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ri-circle-fill'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-1 text-base/20']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                    ...
                    <span class="text-base text-sm"><?php echo e($invoice->formattedTotal); ?></span>
                </div>
                <div class="size-5 rounded-md p-0.5
                <?php if($invoice->status == 'paid'): ?> text-success bg-success/20
                <?php elseif($invoice->status == 'cancelled'): ?> text-info bg-info/20
...
<?php endif; ?>
            ...
            <p class="text-base text-sm text-wrap">Item(s): <?php echo e($item->description); ?> (<?php echo e(__('invoices.invoice_date')); ?>: <?php echo e($invoice->created_at->format('d M Y')); ?>)</p>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
        </div>
    </a>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
</div>
<?php /**PATH /home/farr/Developing/paymenter/themes/water-lab/views/invoices/widget.blade.php ENDPATH**/ ?>