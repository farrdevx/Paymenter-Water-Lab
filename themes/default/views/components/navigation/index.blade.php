<nav class="fixed top-0 z-40 flex items-center justify-between w-full px-4 border-b lg:px-8 bg-background-secondary/80 border-neutral/60 md:h-16 backdrop-blur-lg">
    ...
    <div x-data="{ slideOverOpen: false }" x-init="$watch('slideOverOpen', value => { document.body.style.overflow = value ? 'hidden' : 'auto' })" class="w-full">
        ...
        <div class="flex items-center justify-between w-full h-16">
            ...
            <div class="flex items-center gap-x-2">
                ...
                <button @click="slideOverOpen = !slideOverOpen" class="relative flex items-center justify-center w-10 h-10 transition rounded-lg lg:hidden hover:bg-neutral" aria-label="Toggle Menu">
                    <x-ri-menu-fill x-show="!slideOverOpen" class="transition-transform duration-300 size-5" />
                    <x-ri-close-fill x-show="slideOverOpen" x-cloak class="transition-transform duration-300 size-5" />
                </button>
            </div>
        </div>
            ...
            <div x-show="slideOverOpen" @keydown.window.escape="slideOverOpen = false" class="relative z-[9999]" x-cloak>
                ...
                <div class="fixed inset-0 flex">
                    <div
                        ...
                        class="relative flex flex-col w-screen h-full max-w-xs border-r border-neutral/60 bg-background-secondary/80 backdrop-blur-lg"
                    >
